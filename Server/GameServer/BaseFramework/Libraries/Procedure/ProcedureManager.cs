...
namespace BaseFramework.Procedure
{
    /// <summary>
    /// 流程管理器。
    /// </summary>
    internal sealed class ProcedureManager : BaseFrameworkModule, IProcedureManager
    {
        ...
        public ProcedureBase CurrentProcedure
        {
            get
            {
                ...
                {
                    throw new BaseFrameworkException("You must initialize procedure first.");
                }
        ...
        public void Initialize(IFsmManager fsmManager, params ProcedureBase[] procedures)
        {
            if (fsmManager == null)
            {
                throw new BaseFrameworkException("FSM manager is invalid.");
            }
