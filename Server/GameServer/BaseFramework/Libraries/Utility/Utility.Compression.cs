    ...
    public static partial class Utility
    {
        ...
        public static partial class Compression
        {
            ...
            public static byte[] Compress(byte[] bytes)
            {
                if (bytes == null)
                {
                    throw new BaseFrameworkException("Bytes is invalid.");
                }
            ...
            public static bool Compress(byte[] bytes, int offset, int length, Stream compressedStream)
            {
                ...
                {
                    throw new BaseFrameworkException("Compressed helper is invalid.");
                }
                ...
                {
                    throw new BaseFrameworkException("Offset or length is invalid.");
                }

                if (compressedStream == null)
                {
                    throw new BaseFrameworkException("Compressed stream is invalid.");
                }
                ...
                catch (Exception exception)
                {
                    ...
                    throw new BaseFrameworkException(Text.Format("Can not compress with exception '{0}'.", exception), exception);
                }
            }
            ...
            public static bool Decompress(byte[] bytes, int offset, int length, Stream decompressedStream)
            {
                ...
                {
                    throw new BaseFrameworkException("Decompressed stream is invalid.");
                }
                ...
                catch (Exception exception)
                {
                    ...
                    throw new BaseFrameworkException(Text.Format("Can not decompress with exception '{0}'.", exception), exception);
                }
            }
