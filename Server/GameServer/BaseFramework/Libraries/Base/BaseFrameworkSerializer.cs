...
namespace BaseFramework
{
    ...
    public abstract class BaseFrameworkSerializer<T>
    {
        ...
        /// 初始化游戏框架序列化器基类的新实例。
        /// </summary>
        public BaseFrameworkSerializer()
        {
        ...
        public void RegisterSerializeCallback(byte version, SerializeCallback callback)
        {
            if (callback == null)
            {
                throw new BaseFrameworkException("Serialize callback is invalid.");
            }
        ...
        public void RegisterDeserializeCallback(byte version, DeserializeCallback callback)
        {
            if (callback == null)
            {
                throw new BaseFrameworkException("Deserialize callback is invalid.");
            }
        ...
        public void RegisterTryGetValueCallback(byte version, TryGetValueCallback callback)
        {
            if (callback == null)
            {
                throw new BaseFrameworkException("Try get value callback is invalid.");
            }
        ...
        public bool Serialize(Stream stream, T data)
        {
            ...
            {
                throw new BaseFrameworkException("No serialize callback registered.");
            }
        ...
        public bool Serialize(Stream stream, T data, byte version)
        {
            ...
            {
                throw new BaseFrameworkException(Utility.Text.Format("Serialize callback '{0}' is not exist.", version));
            }
        ...
        public T Deserialize(Stream stream)
        {
            ...
            {
                throw new BaseFrameworkException(Utility.Text.Format("Header is invalid, need '{0}{1}{2}', current '{3}{4}{5}'.", (char)header[0], (char)header[1], (char)header[2], (char)header0, (char)header1, (char)header2));
            }
            ...
            {
                throw new BaseFrameworkException(Utility.Text.Format("Deserialize callback '{0}' is not exist.", version));
            }
