...
namespace BaseFramework
{
    ...
    internal sealed class TaskPool<T> where T : TaskBase
    {
        ...
        private readonly BaseFrameworkLinkedList<ITaskAgent<T>> m_WorkingAgents;
        private readonly BaseFrameworkLinkedList<T> m_WaitingTasks;
        ...
        public TaskPool()
        {
            ...
            m_WorkingAgents = new BaseFrameworkLinkedList<ITaskAgent<T>>();
            m_WaitingTasks = new BaseFrameworkLinkedList<T>();
            m_Paused = false;
        }
        ...
        public void AddAgent(ITaskAgent<T> agent)
        {
            if (agent == null)
            {
                throw new BaseFrameworkException("Task agent is invalid.");
            }
