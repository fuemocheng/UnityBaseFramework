...
namespace XGame
{
    public class ProcedureUpdateResources : ProcedureBase
    {
        ...
        protected override void OnEnter(ProcedureOwner procedureOwner)
        {
            ...
            if (Application.internetReachability == NetworkReachability.ReachableViaCarrierDataNetwork)
            {
                GameEntry.UI.OpenDialog(new DialogParams
                {
                    ...
                    OnClickCancel = delegate (object userData) { UnityBaseFramework.Runtime.BaseEntry.Shutdown(ShutdownType.Quit); },
                });
        ...
        private void OnUpdateResourcesComplete(BaseFramework.Resource.IResourceGroup resourceGroup, bool result)
        {
            if (result)
            {
