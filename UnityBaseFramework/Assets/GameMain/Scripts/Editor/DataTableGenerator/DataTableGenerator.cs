...
namespace XGame.Editor.DataTableTools
{
    public sealed class DataTableGenerator
    {
        ...
        private static void DataTableCodeGenerator(DataTableProcessor dataTableProcessor, StringBuilder codeContent, object userData)
        {
            ...
            codeContent.Replace("__DATA_TABLE_NAME_SPACE__", "XGame");
        ...
        private static string GenerateDataTablePropertyArray(DataTableProcessor dataTableProcessor)
        {
            ...
            foreach (PropertyCollection propertyCollection in propertyCollections)
            {
                ...
                stringBuilder
                    ...
                    .AppendLine("            }")
                    .AppendLine()
                    .AppendFormat("            throw new BaseFrameworkException(Utility.Text.Format(\"Get{0} with invalid id '{{0}}'.\", id));", propertyCollection.Name).AppendLine()
                    .AppendLine("        }")
                    .AppendLine()
                    ...
                    .AppendLine("            {")
                    .AppendFormat("                throw new BaseFrameworkException(Utility.Text.Format(\"Get{0}At with invalid index '{{0}}'.\", index));", propertyCollection.Name).AppendLine()
                    .AppendLine("            }")
                    .AppendLine()
        ...
        private sealed class PropertyCollection
        {
            ...
            public KeyValuePair<int, string> GetItem(int index)
            {
                ...
                {
                    throw new BaseFrameworkException(Utility.Text.Format("GetItem with invalid index '{0}'.", index));
                }
