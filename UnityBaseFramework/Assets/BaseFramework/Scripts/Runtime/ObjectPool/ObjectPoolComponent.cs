...
namespace UnityBaseFramework.Runtime
{
    ...
    [AddComponentMenu("Base Framework/Object Pool")]
    public sealed class ObjectPoolComponent : BaseFrameworkComponent
    {
        ...
        protected override void Awake()
        {
            ...
            m_ObjectPoolManager = BaseFrameworkEntry.GetModule<IObjectPoolManager>();
