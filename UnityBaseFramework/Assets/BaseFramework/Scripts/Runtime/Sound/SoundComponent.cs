...
#if UNITY_5_3
using BaseFramework.Scene;
#endif
using BaseFramework.Sound;
...
namespace UnityBaseFramework.Runtime
{
    ...
    [AddComponentMenu("Base Framework/Sound")]
    public sealed partial class SoundComponent : BaseFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_SoundHelperTypeName = "UnityBaseFramework.Runtime.DefaultSoundHelper";

        [SerializeField]
        private SoundHelperBase m_CustomSoundHelper = null;

        [SerializeField]
        private string m_SoundGroupHelperTypeName = "UnityBaseFramework.Runtime.DefaultSoundGroupHelper";

        [SerializeField]
        private SoundGroupHelperBase m_CustomSoundGroupHelper = null;

        [SerializeField]
        private string m_SoundAgentHelperTypeName = "UnityBaseFramework.Runtime.DefaultSoundAgentHelper";
        ...
        protected override void Awake()
        {
            ...
            m_SoundManager = BaseFrameworkEntry.GetModule<ISoundManager>();
...
#else
            ISceneManager sceneManager = BaseFrameworkEntry.GetModule<ISceneManager>();
        ...
        private void Start()
        {
            ...
            {
                m_SoundManager.SetResourceManager(BaseFrameworkEntry.GetModule<IResourceManager>());
            }
        ...
        private void OnPlaySoundSuccess(object sender, BaseFramework.Sound.PlaySoundSuccessEventArgs e)
        {
        ...
        private void OnPlaySoundFailure(object sender, BaseFramework.Sound.PlaySoundFailureEventArgs e)
        {
        ...
        private void OnPlaySoundUpdate(object sender, BaseFramework.Sound.PlaySoundUpdateEventArgs e)
        {
            m_EventComponent.Fire(this, PlaySoundUpdateEventArgs.Create(e));
        }

        private void OnPlaySoundDependencyAsset(object sender, BaseFramework.Sound.PlaySoundDependencyAssetEventArgs e)
        {
            m_EventComponent.Fire(this, PlaySoundDependencyAssetEventArgs.Create(e));
        }

        private void OnLoadSceneSuccess(object sender, BaseFramework.Scene.LoadSceneSuccessEventArgs e)
        {
            RefreshAudioListener();
        }

        private void OnLoadSceneFailure(object sender, BaseFramework.Scene.LoadSceneFailureEventArgs e)
        {
            RefreshAudioListener();
        }

        private void OnUnloadSceneSuccess(object sender, BaseFramework.Scene.UnloadSceneSuccessEventArgs e)
        {
            RefreshAudioListener();
        }

        private void OnUnloadSceneFailure(object sender, BaseFramework.Scene.UnloadSceneFailureEventArgs e)
        {
            RefreshAudioListener();
        }
