...
namespace UnityBaseFramework.Runtime
{
    ...
    [AddComponentMenu("Base Framework/Network")]
    public sealed class NetworkComponent : BaseFrameworkComponent
    {
        ...
        protected override void Awake()
        {
            ...
            m_NetworkManager = BaseFrameworkEntry.GetModule<INetworkManager>();
        ...
        private void OnNetworkConnected(object sender, BaseFramework.Network.NetworkConnectedEventArgs e)
        {
            m_EventComponent.Fire(this, NetworkConnectedEventArgs.Create(e));
        }

        private void OnNetworkClosed(object sender, BaseFramework.Network.NetworkClosedEventArgs e)
        {
            m_EventComponent.Fire(this, NetworkClosedEventArgs.Create(e));
        }

        private void OnNetworkMissHeartBeat(object sender, BaseFramework.Network.NetworkMissHeartBeatEventArgs e)
        {
            m_EventComponent.Fire(this, NetworkMissHeartBeatEventArgs.Create(e));
        }

        private void OnNetworkError(object sender, BaseFramework.Network.NetworkErrorEventArgs e)
        {
            m_EventComponent.Fire(this, NetworkErrorEventArgs.Create(e));
        }

        private void OnNetworkCustomError(object sender, BaseFramework.Network.NetworkCustomErrorEventArgs e)
        {
