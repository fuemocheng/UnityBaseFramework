...
namespace UnityBaseFramework.Runtime
{
    ...
    public sealed class AndroidFileSystemStream : FileSystemStream
    {
        ...
        static AndroidFileSystemStream()
        {
            ...
            if (unityPlayer == null)
            {
                throw new BaseFrameworkException("Unity player is invalid.");
            }

            AndroidJavaObject currentActivity = unityPlayer.GetStatic<AndroidJavaObject>("currentActivity");
            if (currentActivity == null)
            {
                throw new BaseFrameworkException("Current activity is invalid.");
            }

            AndroidJavaObject assetManager = currentActivity.Call<AndroidJavaObject>("getAssets");
            if (assetManager == null)
            {
                throw new BaseFrameworkException("Asset manager is invalid.");
            }
        ...
        public AndroidFileSystemStream(string fullPath, FileSystemAccess access, bool createNew)
        {
            ...
            {
                throw new BaseFrameworkException(Utility.Text.Format("'{0}' is not supported in AndroidFileSystemStream.", access));
            }

            if (createNew)
            {
                throw new BaseFrameworkException("Create new is not supported in AndroidFileSystemStream.");
            }

            int position = fullPath.LastIndexOf(SplitFlag, StringComparison.Ordinal);
            if (position < 0)
            {
                throw new BaseFrameworkException("Can not find split flag in full path.");
            }
            ...
            {
                throw new BaseFrameworkException(Utility.Text.Format("Open file '{0}' from Android asset manager failure.", fullPath));
            }
        ...
        protected override long Position
        {
            get
            {
                throw new BaseFrameworkException("Get position is not supported in AndroidFileSystemStream.");
            }
            set
            {
        ...
        {
            throw new BaseFrameworkException("SetLength is not supported in AndroidFileSystemStream.");
        }
        ...
        {
            throw new BaseFrameworkException("WriteByte is not supported in AndroidFileSystemStream.");
        }
        ...
        {
            throw new BaseFrameworkException("Write is not supported in AndroidFileSystemStream.");
        }
        ...
        {
            throw new BaseFrameworkException("Flush is not supported in AndroidFileSystemStream.");
        }
