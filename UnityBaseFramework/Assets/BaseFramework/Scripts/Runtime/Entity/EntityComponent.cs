...
namespace UnityBaseFramework.Runtime
{
    ...
    [AddComponentMenu("Base Framework/Entity")]
    public sealed partial class EntityComponent : BaseFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_EntityHelperTypeName = "UnityBaseFramework.Runtime.DefaultEntityHelper";

        [SerializeField]
        private EntityHelperBase m_CustomEntityHelper = null;

        [SerializeField]
        private string m_EntityGroupHelperTypeName = "UnityBaseFramework.Runtime.DefaultEntityGroupHelper";
        ...
        protected override void Awake()
        {
            ...
            m_EntityManager = BaseFrameworkEntry.GetModule<IEntityManager>();
        ...
        private void Start()
        {
            ...
            {
                m_EntityManager.SetResourceManager(BaseFrameworkEntry.GetModule<IResourceManager>());
            }

            m_EntityManager.SetObjectPoolManager(BaseFrameworkEntry.GetModule<IObjectPoolManager>());
        ...
        private void OnShowEntitySuccess(object sender, BaseFramework.Entity.ShowEntitySuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ShowEntitySuccessEventArgs.Create(e));
        }

        private void OnShowEntityFailure(object sender, BaseFramework.Entity.ShowEntityFailureEventArgs e)
        {
        ...
        private void OnShowEntityUpdate(object sender, BaseFramework.Entity.ShowEntityUpdateEventArgs e)
        {
            m_EventComponent.Fire(this, ShowEntityUpdateEventArgs.Create(e));
        }

        private void OnShowEntityDependencyAsset(object sender, BaseFramework.Entity.ShowEntityDependencyAssetEventArgs e)
        {
            m_EventComponent.Fire(this, ShowEntityDependencyAssetEventArgs.Create(e));
        }

        private void OnHideEntityComplete(object sender, BaseFramework.Entity.HideEntityCompleteEventArgs e)
        {
