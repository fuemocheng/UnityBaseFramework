...
namespace UnityBaseFramework.Runtime
{
    ...
    [AddComponentMenu("Base Framework/Config")]
    public sealed class ConfigComponent : BaseFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_ConfigHelperTypeName = "UnityBaseFramework.Runtime.DefaultConfigHelper";
        ...
        protected override void Awake()
        {
            ...
            m_ConfigManager = BaseFrameworkEntry.GetModule<IConfigManager>();
        ...
        private void Start()
        {
            ...
            {
                m_ConfigManager.SetResourceManager(BaseFrameworkEntry.GetModule<IResourceManager>());
            }
