...
namespace UnityBaseFramework.Runtime
{
    ...
    [AddComponentMenu("Base Framework/Resource")]
    public sealed class ResourceComponent : BaseFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_ResourceHelperTypeName = "UnityBaseFramework.Runtime.DefaultResourceHelper";

        [SerializeField]
        private ResourceHelperBase m_CustomResourceHelper = null;

        [SerializeField]
        private string m_LoadResourceAgentHelperTypeName = "UnityBaseFramework.Runtime.DefaultLoadResourceAgentHelper";
        ...
        private void Start()
        {
            BaseComponent baseComponent = BaseEntry.GetComponent<BaseComponent>();
            ...
            m_EventComponent = BaseEntry.GetComponent<EventComponent>();
            ...
            m_ResourceManager = m_EditorResourceMode ? baseComponent.EditorResourceHelper : BaseFrameworkEntry.GetModule<IResourceManager>();
            ...
            m_ResourceManager.SetObjectPoolManager(BaseFrameworkEntry.GetModule<IObjectPoolManager>());
            m_ResourceManager.SetFileSystemManager(BaseFrameworkEntry.GetModule<IFileSystemManager>());
            m_ResourceManager.SetDownloadManager(BaseFrameworkEntry.GetModule<IDownloadManager>());
        ...
        private void OnResourceVerifyStart(object sender, BaseFramework.Resource.ResourceVerifyStartEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceVerifyStartEventArgs.Create(e));
        }

        private void OnResourceVerifySuccess(object sender, BaseFramework.Resource.ResourceVerifySuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceVerifySuccessEventArgs.Create(e));
        }

        private void OnResourceVerifyFailure(object sender, BaseFramework.Resource.ResourceVerifyFailureEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceVerifyFailureEventArgs.Create(e));
        }

        private void OnResourceApplyStart(object sender, BaseFramework.Resource.ResourceApplyStartEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceApplyStartEventArgs.Create(e));
        }

        private void OnResourceApplySuccess(object sender, BaseFramework.Resource.ResourceApplySuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceApplySuccessEventArgs.Create(e));
        }

        private void OnResourceApplyFailure(object sender, BaseFramework.Resource.ResourceApplyFailureEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceApplyFailureEventArgs.Create(e));
        }

        private void OnResourceUpdateStart(object sender, BaseFramework.Resource.ResourceUpdateStartEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceUpdateStartEventArgs.Create(e));
        }

        private void OnResourceUpdateChanged(object sender, BaseFramework.Resource.ResourceUpdateChangedEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceUpdateChangedEventArgs.Create(e));
        }

        private void OnResourceUpdateSuccess(object sender, BaseFramework.Resource.ResourceUpdateSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceUpdateSuccessEventArgs.Create(e));
        }

        private void OnResourceUpdateFailure(object sender, BaseFramework.Resource.ResourceUpdateFailureEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceUpdateFailureEventArgs.Create(e));
        }

        private void OnResourceUpdateAllComplete(object sender, BaseFramework.Resource.ResourceUpdateAllCompleteEventArgs e)
        {
