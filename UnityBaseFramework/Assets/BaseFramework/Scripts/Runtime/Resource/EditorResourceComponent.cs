...
namespace UnityBaseFramework.Runtime
{
    ...
    public sealed class EditorResourceComponent : MonoBehaviour, IResourceManager
    {
        ...
        private BaseFrameworkLinkedList<LoadAssetInfo> m_LoadAssetInfos = null;
        private BaseFrameworkLinkedList<LoadSceneInfo> m_LoadSceneInfos = null;
        private BaseFrameworkLinkedList<UnloadSceneInfo> m_UnloadSceneInfos = null;
...
#pragma warning disable 0067, 0414
        ...
        /// 资源校验开始事件。
        /// </summary>
        public event EventHandler<BaseFramework.Resource.ResourceVerifyStartEventArgs> ResourceVerifyStart = null;

        /// <summary>
        /// 资源校验成功事件。
        /// </summary>
        public event EventHandler<BaseFramework.Resource.ResourceVerifySuccessEventArgs> ResourceVerifySuccess = null;

        /// <summary>
        /// 资源校验失败事件。
        /// </summary>
        public event EventHandler<BaseFramework.Resource.ResourceVerifyFailureEventArgs> ResourceVerifyFailure = null;

        /// <summary>
        /// 资源应用开始事件。
        /// </summary>
        public event EventHandler<BaseFramework.Resource.ResourceApplyStartEventArgs> ResourceApplyStart = null;

        /// <summary>
        /// 资源应用成功事件。
        /// </summary>
        public event EventHandler<BaseFramework.Resource.ResourceApplySuccessEventArgs> ResourceApplySuccess = null;

        /// <summary>
        /// 资源应用失败事件。
        /// </summary>
        public event EventHandler<BaseFramework.Resource.ResourceApplyFailureEventArgs> ResourceApplyFailure = null;

        /// <summary>
        /// 资源更新开始事件。
        /// </summary>
        public event EventHandler<BaseFramework.Resource.ResourceUpdateStartEventArgs> ResourceUpdateStart = null;

        /// <summary>
        /// 资源更新改变事件。
        /// </summary>
        public event EventHandler<BaseFramework.Resource.ResourceUpdateChangedEventArgs> ResourceUpdateChanged = null;

        /// <summary>
        /// 资源更新成功事件。
        /// </summary>
        public event EventHandler<BaseFramework.Resource.ResourceUpdateSuccessEventArgs> ResourceUpdateSuccess = null;

        /// <summary>
        /// 资源更新失败事件。
        /// </summary>
        public event EventHandler<BaseFramework.Resource.ResourceUpdateFailureEventArgs> ResourceUpdateFailure = null;

        /// <summary>
        /// 资源更新全部完成事件。
        /// </summary>
        public event EventHandler<BaseFramework.Resource.ResourceUpdateAllCompleteEventArgs> ResourceUpdateAllComplete = null;
...
#pragma warning restore 0067, 0414
        ...
        private void Awake()
        {
            ...
            m_LoadAssetInfos = new BaseFrameworkLinkedList<LoadAssetInfo>();
            m_LoadSceneInfos = new BaseFrameworkLinkedList<LoadSceneInfo>();
            m_UnloadSceneInfos = new BaseFrameworkLinkedList<UnloadSceneInfo>();
