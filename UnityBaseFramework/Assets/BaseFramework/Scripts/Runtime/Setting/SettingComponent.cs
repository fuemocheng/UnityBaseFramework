...
namespace UnityBaseFramework.Runtime
{
    ...
    [AddComponentMenu("Base Framework/Setting")]
    public sealed class SettingComponent : BaseFrameworkComponent
    {
        private ISettingManager m_SettingManager = null;

        [SerializeField]
        private string m_SettingHelperTypeName = "UnityBaseFramework.Runtime.DefaultSettingHelper";
        ...
        protected override void Awake()
        {
            ...
            m_SettingManager = BaseFrameworkEntry.GetModule<ISettingManager>();
