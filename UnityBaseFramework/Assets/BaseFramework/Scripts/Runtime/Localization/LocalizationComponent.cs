...
namespace UnityBaseFramework.Runtime
{
    ...
    [AddComponentMenu("Base Framework/Localization")]
    public sealed class LocalizationComponent : BaseFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_LocalizationHelperTypeName = "UnityBaseFramework.Runtime.DefaultLocalizationHelper";
        ...
        protected override void Awake()
        {
            ...
            m_LocalizationManager = BaseFrameworkEntry.GetModule<ILocalizationManager>();
        ...
        private void Start()
        {
            ...
            {
                m_LocalizationManager.SetResourceManager(BaseFrameworkEntry.GetModule<IResourceManager>());
            }
