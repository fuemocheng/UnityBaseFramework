...
namespace UnityBaseFramework.Runtime
{
    ...
    [AddComponentMenu("Base Framework/Debugger")]
    public sealed partial class DebuggerComponent : BaseFrameworkComponent
    {
        ...
        protected override void Awake()
        {
            ...
            m_DebuggerManager = BaseFrameworkEntry.GetModule<IDebuggerManager>();
        ...
        private void OnGUI()
        {
            ...
            if (m_ShowFullWindow)
            {
                m_WindowRect = GUILayout.Window(0, m_WindowRect, DrawWindow, "<b>BASE FRAMEWORK DEBUGGER</b>");
            }
            else
            {
