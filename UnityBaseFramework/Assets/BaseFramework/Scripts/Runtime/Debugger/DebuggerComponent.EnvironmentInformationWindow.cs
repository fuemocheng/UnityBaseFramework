...
namespace UnityBaseFramework.Runtime
{
    public sealed partial class DebuggerComponent : BaseFrameworkComponent
    {
        private sealed class EnvironmentInformationWindow : ScrollableDebuggerWindowBase
        {
            ...
            {
                m_BaseComponent = BaseEntry.GetComponent<BaseComponent>();
                ...
                m_ResourceComponent = BaseEntry.GetComponent<ResourceComponent>();
...
#endif
                    DrawItem("Base Framework Version", Version.BaseFrameworkVersion);
