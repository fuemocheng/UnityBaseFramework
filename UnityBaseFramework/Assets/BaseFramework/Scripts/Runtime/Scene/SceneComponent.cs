...
namespace UnityBaseFramework.Runtime
{
    ...
    [AddComponentMenu("Base Framework/Scene")]
    public sealed class SceneComponent : BaseFrameworkComponent
    {
        ...
        private Scene m_BaseFrameworkScene = default(Scene);
        ...
        protected override void Awake()
        {
            ...
            m_SceneManager = BaseFrameworkEntry.GetModule<ISceneManager>();
            ...
            m_BaseFrameworkScene = SceneManager.GetSceneAt(BaseEntry.BaseFrameworkSceneId);
            if (!m_BaseFrameworkScene.IsValid())
            {
                Log.Fatal("Base Framework scene is invalid.");
                return;
            }
        }
        ...
        private void Start()
        {
            ...
            {
                m_SceneManager.SetResourceManager(BaseFrameworkEntry.GetModule<IResourceManager>());
            }
        }
        ...
        private void RefreshSceneOrder()
        {
            if (m_SceneOrder.Count > 0)
            {
                ...
                if (maxSceneName == null)
                {
                    SetActiveScene(m_BaseFrameworkScene);
                    return;
                }
        ...
        private void OnLoadSceneUpdate(object sender, BaseFramework.Scene.LoadSceneUpdateEventArgs e)
        {
            m_EventComponent.Fire(this, LoadSceneUpdateEventArgs.Create(e));
        }

        private void OnLoadSceneDependencyAsset(object sender, BaseFramework.Scene.LoadSceneDependencyAssetEventArgs e)
        {
