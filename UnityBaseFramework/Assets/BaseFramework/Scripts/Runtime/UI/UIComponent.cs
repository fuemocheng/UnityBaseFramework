...
namespace UnityBaseFramework.Runtime
{
    ...
    [AddComponentMenu("Base Framework/UI")]
    public sealed partial class UIComponent : BaseFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_UIFormHelperTypeName = "UnityBaseFramework.Runtime.DefaultUIFormHelper";

        [SerializeField]
        private UIFormHelperBase m_CustomUIFormHelper = null;

        [SerializeField]
        private string m_UIGroupHelperTypeName = "UnityBaseFramework.Runtime.DefaultUIGroupHelper";
        ...
        protected override void Awake()
        {
            ...
            m_UIManager = BaseFrameworkEntry.GetModule<IUIManager>();
            if (m_UIManager == null)
            {
        ...
        private void Start()
        {
            ...
            {
                m_UIManager.SetResourceManager(BaseFrameworkEntry.GetModule<IResourceManager>());
            }

            m_UIManager.SetObjectPoolManager(BaseFrameworkEntry.GetModule<IObjectPoolManager>());
        ...
        private void OnOpenUIFormSuccess(object sender, BaseFramework.UI.OpenUIFormSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, OpenUIFormSuccessEventArgs.Create(e));
        }

        private void OnOpenUIFormFailure(object sender, BaseFramework.UI.OpenUIFormFailureEventArgs e)
        {
        ...
        private void OnOpenUIFormUpdate(object sender, BaseFramework.UI.OpenUIFormUpdateEventArgs e)
        {
            m_EventComponent.Fire(this, OpenUIFormUpdateEventArgs.Create(e));
        }

        private void OnOpenUIFormDependencyAsset(object sender, BaseFramework.UI.OpenUIFormDependencyAssetEventArgs e)
        {
            m_EventComponent.Fire(this, OpenUIFormDependencyAssetEventArgs.Create(e));
        }

        private void OnCloseUIFormComplete(object sender, BaseFramework.UI.CloseUIFormCompleteEventArgs e)
        {
