...
namespace UnityBaseFramework.Runtime
{
    ...
    public sealed class DownloadComponent : BaseFrameworkComponent
    {
        ...
        protected override void Awake()
        {
            ...
            m_DownloadManager = BaseFrameworkEntry.GetModule<IDownloadManager>();
        ...
        private void OnDownloadStart(object sender, BaseFramework.Download.DownloadStartEventArgs e)
        {
            m_EventComponent.Fire(this, DownloadStartEventArgs.Create(e));
        }

        private void OnDownloadUpdate(object sender, BaseFramework.Download.DownloadUpdateEventArgs e)
        {
            m_EventComponent.Fire(this, DownloadUpdateEventArgs.Create(e));
        }

        private void OnDownloadSuccess(object sender, BaseFramework.Download.DownloadSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, DownloadSuccessEventArgs.Create(e));
        }

        private void OnDownloadFailure(object sender, BaseFramework.Download.DownloadFailureEventArgs e)
        {
