...
namespace UnityBaseFramework.Runtime
{
    ...
    [AddComponentMenu("Base Framework/Data Node")]
    public sealed class DataNodeComponent : BaseFrameworkComponent
    {
        ...
        protected override void Awake()
        {
            ...
            m_DataNodeManager = BaseFrameworkEntry.GetModule<IDataNodeManager>();
