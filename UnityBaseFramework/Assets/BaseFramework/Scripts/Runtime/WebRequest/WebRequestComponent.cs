using BaseFramework;
using BaseFramework.WebRequest;
...
namespace UnityBaseFramework.Runtime
{
    ...
    public sealed class WebRequestComponent : BaseFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_WebRequestAgentHelperTypeName = "UnityBaseFramework.Runtime.UnityWebRequestAgentHelper";
        ...
        private void OnWebRequestStart(object sender, BaseFramework.WebRequest.WebRequestStartEventArgs e)
        {
            m_EventComponent.Fire(this, WebRequestStartEventArgs.Create(e));
        }

        private void OnWebRequestSuccess(object sender, BaseFramework.WebRequest.WebRequestSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, WebRequestSuccessEventArgs.Create(e));
        }

        private void OnWebRequestFailure(object sender, BaseFramework.WebRequest.WebRequestFailureEventArgs e)
        {
