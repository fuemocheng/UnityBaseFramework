...
namespace UnityBaseFramework.Runtime
{
    ...
    [AddComponentMenu("Base Framework/Data Table")]
    public sealed class DataTableComponent : BaseFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_DataTableHelperTypeName = "UnityBaseFramework.Runtime.DefaultDataTableHelper";
        ...
        protected override void Awake()
        {
            ...
            m_DataTableManager = BaseFrameworkEntry.GetModule<IDataTableManager>();
        ...
        private void Start()
        {
            ...
            {
                m_DataTableManager.SetResourceManager(BaseFrameworkEntry.GetModule<IResourceManager>());
            }
