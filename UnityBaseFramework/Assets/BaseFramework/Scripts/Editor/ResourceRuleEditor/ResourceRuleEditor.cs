...
using GFResource = UnityBaseFramework.Editor.ResourceTools.Resource;

namespace XGame.Editor.ResourceTools
{
    /// <summary>
    ...
    public class ResourceRuleEditor : EditorWindow
    {
        ...
        [MenuItem("Base Framework/Resource Tools/Resource Rule Editor", false, 50)]
        static void Open()
        {
