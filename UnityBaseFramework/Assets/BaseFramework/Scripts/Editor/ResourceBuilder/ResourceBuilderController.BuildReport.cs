...
namespace UnityBaseFramework.Editor.ResourceTools
{
    public sealed partial class ResourceBuilderController
    {
        private sealed class BuildReport
        {
            ...
            private string m_BaseFrameworkVersion = null;
            ...
            public void Initialize(string buildReportPath, string productName, string companyName, string gameIdentifier, string baseFrameworkVersion, string unityVersion, string applicableGameVersion, int internalResourceVersion,
                Platform platforms, AssetBundleCompressionType assetBundleCompression, string compressionHelperTypeName, bool additionalCompressionSelected, bool forceRebuildAssetBundleSelected, string buildEventHandlerTypeName, string outputDirectory, BuildAssetBundleOptions buildAssetBundleOptions, SortedDictionary<string, ResourceData> resourceDatas)
            {
                ...
                {
                    throw new BaseFrameworkException("Build report path is invalid.");
                }
                ...
                m_BaseFrameworkVersion = baseFrameworkVersion;
            ...
            public void SaveReport()
            {
                ...
                xmlSummary.AppendChild(xmlElement);
                xmlElement = xmlDocument.CreateElement("BaseFrameworkVersion");
                xmlElement.InnerText = m_BaseFrameworkVersion;
                xmlSummary.AppendChild(xmlElement);
