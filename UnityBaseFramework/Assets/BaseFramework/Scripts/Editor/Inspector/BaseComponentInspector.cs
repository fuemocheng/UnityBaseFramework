...
namespace UnityBaseFramework.Editor
{
    ...
    internal sealed class BaseComponentInspector : BaseFrameworkInspector
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUI.BeginDisabledGroup(EditorApplication.isPlayingOrWillChangePlaymode);
            {
                ...
                {
                    EditorGUILayout.HelpBox("Editor resource mode option is only for editor mode. Base Framework will use editor resource files, which you should validate first.", MessageType.Warning);
        ...
        private void RefreshTypeNames()
        {
            ...
            logHelperTypeNames.AddRange(Type.GetRuntimeTypeNames(typeof(BaseFrameworkLog.ILogHelper)));
