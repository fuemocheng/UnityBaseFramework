...
namespace UnityBaseFramework.Editor.ResourceTools
{
    ...
    public sealed class ResourceCollection
    {
        ...
        {
            m_ConfigurationPath = Type.GetConfigurationPath<ResourceCollectionConfigPathAttribute>() ?? Utility.Path.GetRegularPath(Path.Combine(Application.dataPath, "BaseFramework/Configs/ResourceCollection.xml"));
