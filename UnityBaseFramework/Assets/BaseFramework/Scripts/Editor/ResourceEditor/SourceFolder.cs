...
namespace UnityBaseFramework.Editor.ResourceTools
{
    public sealed class SourceFolder
    {
        ...
        public SourceFolder GetFolder(string name)
        {
            ...
            {
                throw new BaseFrameworkException("Source folder name is invalid.");
            }
        ...
        public SourceFolder AddFolder(string name)
        {
            ...
            if (folder != null)
            {
                throw new BaseFrameworkException("Source folder is already exist.");
            }
        ...
        public SourceAsset GetAsset(string name)
        {
            if (string.IsNullOrEmpty(name))
            {
                throw new BaseFrameworkException("Source asset name is invalid.");
            }
        ...
        public SourceAsset AddAsset(string guid, string path, string name)
        {
            ...
            {
                throw new BaseFrameworkException("Source asset guid is invalid.");
            }

            if (string.IsNullOrEmpty(path))
            {
                throw new BaseFrameworkException("Source asset path is invalid.");
            }
            ...
            if (asset != null)
            {
                throw new BaseFrameworkException(Utility.Text.Format("Source asset '{0}' is already exist.", name));
            }
