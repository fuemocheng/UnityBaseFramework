...
namespace UnityBaseFramework.Editor.ResourceTools
{
    public sealed class ResourceEditorController
    {
        ...
        {
            m_ConfigurationPath = Type.GetConfigurationPath<ResourceEditorConfigPathAttribute>() ?? Utility.Path.GetRegularPath(Path.Combine(Application.dataPath, "BaseFramework/Configs/ResourceEditor.xml"));
        ...
        public event BaseFrameworkAction<SourceAsset[]> OnAssetAssigned = null;

        public event BaseFrameworkAction<SourceAsset[]> OnAssetUnassigned = null;
