    ...
    internal sealed partial class ResourceEditor : EditorWindow
    {
        private sealed class ResourceFolder
        {
            ...
            public ResourceFolder GetFolder(string name)
            {
                ...
                {
                    throw new BaseFrameworkException("Resource folder name is invalid.");
                }
            ...
            public ResourceFolder AddFolder(string name)
            {
                ...
                if (folder != null)
                {
                    throw new BaseFrameworkException("Resource folder is already exist.");
                }
            ...
            public ResourceItem GetItem(string name)
            {
                if (string.IsNullOrEmpty(name))
                {
                    throw new BaseFrameworkException("Resource item name is invalid.");
                }
            ...
            public void AddItem(string name, Resource resource)
            {
                ...
                if (item != null)
                {
                    throw new BaseFrameworkException("Resource item is already exist.");
                }
