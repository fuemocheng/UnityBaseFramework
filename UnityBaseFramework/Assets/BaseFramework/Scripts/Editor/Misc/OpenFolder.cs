...
namespace UnityBaseFramework.Editor
{
    ...
    public static class OpenFolder
    {
        ...
        /// 打开 Data Path 文件夹。
        /// </summary>
        [MenuItem("Base Framework/Open Folder/Data Path", false, 10)]
        ...
        /// </summary>
        [MenuItem("Base Framework/Open Folder/Persistent Data Path", false, 11)]
        ...
        /// </summary>
        [MenuItem("Base Framework/Open Folder/Streaming Assets Path", false, 12)]
        ...
        /// </summary>
        [MenuItem("Base Framework/Open Folder/Temporary Cache Path", false, 13)]
        ...
        /// </summary>
        [MenuItem("Base Framework/Open Folder/Console Log Path", false, 14)]
        ...
        public static void Execute(string folder)
        {
            ...
            switch (Application.platform)
            {
                ...
                default:
                    throw new BaseFrameworkException(Utility.Text.Format("Not support open folder on '{0}' platform.", Application.platform));
            }
        }
    }
}
