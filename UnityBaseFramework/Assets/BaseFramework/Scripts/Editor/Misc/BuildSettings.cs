...
namespace UnityBaseFramework.Editor
{
    ...
    internal static class BuildSettings
    {
        ...
        {
            s_ConfigurationPath = Type.GetConfigurationPath<BuildSettingsConfigPathAttribute>() ?? Utility.Path.GetRegularPath(Path.Combine(Application.dataPath, "BaseFramework/Configs/BuildSettings.xml"));
        ...
        /// 将构建场景设置为默认。
        /// </summary>
        [MenuItem("Base Framework/Scenes in Build Settings/Default Scenes", false, 20)]
        ...
        /// 将构建场景设置为所有。
        /// </summary>
        [MenuItem("Base Framework/Scenes in Build Settings/All Scenes", false, 21)]
