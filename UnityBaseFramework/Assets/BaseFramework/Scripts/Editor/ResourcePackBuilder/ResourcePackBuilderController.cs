...
namespace UnityBaseFramework.Editor.ResourceTools
{
    public sealed class ResourcePackBuilderController
    {
        ...
        public event BaseFrameworkAction<int> OnBuildResourcePacksStarted = null;

        public event BaseFrameworkAction<int, int> OnBuildResourcePacksCompleted = null;

        public event BaseFrameworkAction<int, int, string, string> OnBuildResourcePackSuccess = null;

        public event BaseFrameworkAction<int, int, string, string> OnBuildResourcePackFailure = null;
