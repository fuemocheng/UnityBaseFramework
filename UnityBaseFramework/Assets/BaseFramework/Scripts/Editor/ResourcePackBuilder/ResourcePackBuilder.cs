...
namespace UnityBaseFramework.Editor.ResourceTools
{
    ...
    internal sealed class ResourcePackBuilder : EditorWindow
    {
        ...
        [MenuItem("Base Framework/Resource Tools/Resource Pack Builder", false, 43)]
        ...
        private void OnGUI()
        {
            EditorGUILayout.BeginVertical(GUILayout.Width(position.width), GUILayout.Height(position.height));
            {
                ...
                EditorGUILayout.BeginVertical("box");
                {
                    ...
                    EditorGUILayout.BeginHorizontal();
                    {
                        EditorGUILayout.LabelField("Base Framework Version", GUILayout.Width(160f));
                        EditorGUILayout.LabelField(m_Controller.BaseFrameworkVersion);
                    }
                    EditorGUILayout.EndHorizontal();
                    EditorGUILayout.BeginHorizontal();
                    {
