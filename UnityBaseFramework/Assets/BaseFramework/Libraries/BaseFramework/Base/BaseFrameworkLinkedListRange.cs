...
namespace BaseFramework
{
    ...
    public struct BaseFrameworkLinkedListRange<T> : IEnumerable<T>, IEnumerable
    {
        ...
        public BaseFrameworkLinkedListRange(LinkedListNode<T> first, LinkedListNode<T> terminal)
        {
        ...
        {
            private readonly BaseFrameworkLinkedListRange<T> m_BaseFrameworkLinkedListRange;
            private LinkedListNode<T> m_Current;
            private T m_CurrentValue;

            internal Enumerator(BaseFrameworkLinkedListRange<T> range)
            {
                if (!range.IsValid)
                {
                    throw new BaseFrameworkException("Range is invalid.");
                ...
                m_BaseFrameworkLinkedListRange = range;
                m_Current = m_BaseFrameworkLinkedListRange.m_First;
            ...
            {
                if (m_Current == null || m_Current == m_BaseFrameworkLinkedListRange.m_Terminal)
                {
                    return false;
                }
