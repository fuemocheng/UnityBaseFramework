...
namespace BaseFramework
{
    ...
    {
        private readonly BaseFrameworkMultiDictionary<int, EventHandler<T>> m_EventHandlers;
        ...
        {
            m_EventHandlers = new BaseFrameworkMultiDictionary<int, EventHandler<T>>();
        ...
        {
            BaseFrameworkLinkedListRange<EventHandler<T>> range = default(BaseFrameworkLinkedListRange<EventHandler<T>>);
        ...
        public bool Check(int id, EventHandler<T> handler)
        {
            if (handler == null)
            {
                throw new BaseFrameworkException("Event handler is invalid.");
            }
        ...
        public void Subscribe(int id, EventHandler<T> handler)
        {
            ...
            {
                throw new BaseFrameworkException(Utility.Text.Format("Event '{0}' not allow multi handler.", id));
            }
            else if ((m_EventPoolMode & EventPoolMode.AllowDuplicateHandler) != EventPoolMode.AllowDuplicateHandler && Check(id, handler))
            {
                throw new BaseFrameworkException(Utility.Text.Format("Event '{0}' not allow duplicate handler.", id));
            }
            else
            {
                m_EventHandlers.Add(id, handler);
        ...
        public void Unsubscribe(int id, EventHandler<T> handler)
        {
            ...
            {
                throw new BaseFrameworkException(Utility.Text.Format("Event '{0}' not exists specified handler.", id));
            }
        }
        ...
        public void Fire(object sender, T e)
        {
            if (e == null)
            {
                throw new BaseFrameworkException("Event is invalid.");
            }
        ...
        private void HandleEvent(object sender, T e)
        {
            ...
            {
                throw new BaseFrameworkException(Utility.Text.Format("Event '{0}' not allow no handler.", e.Id));
            }
        }
    }
}
