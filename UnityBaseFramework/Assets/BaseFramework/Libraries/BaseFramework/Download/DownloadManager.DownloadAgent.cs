...
namespace BaseFramework.Download
{
    internal sealed partial class DownloadManager : BaseFrameworkModule, IDownloadManager
    {
        /// <summary>
        /// 下载代理。
        /// </summary>
        private sealed class DownloadAgent : ITaskAgent<DownloadTask>, IDisposable
        {
            ...
            public BaseFrameworkAction<DownloadAgent> DownloadAgentStart;
            public BaseFrameworkAction<DownloadAgent, int> DownloadAgentUpdate;
            public BaseFrameworkAction<DownloadAgent, long> DownloadAgentSuccess;
            public BaseFrameworkAction<DownloadAgent, string> DownloadAgentFailure;
            ...
            public DownloadAgent(IDownloadAgentHelper downloadAgentHelper)
            {
                ...
                {
                    throw new BaseFrameworkException("Download agent helper is invalid.");
                }
            ...
            public StartTaskStatus Start(DownloadTask task)
            {
                if (task == null)
                {
                    throw new BaseFrameworkException("Task is invalid.");
                }
            ...
            private void OnDownloadAgentHelperComplete(object sender, DownloadAgentHelperCompleteEventArgs e)
            {
                ...
                {
                    throw new BaseFrameworkException("Internal download error.");
                }
