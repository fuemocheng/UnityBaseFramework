...
namespace BaseFramework.UI
{
    ...
    /// 界面管理器。
    /// </summary>
    internal sealed partial class UIManager : BaseFrameworkModule, IUIManager
    {
        ...
        public void SetUIFormHelper(IUIFormHelper uiFormHelper)
        {
            ...
            {
                throw new BaseFrameworkException("UI form helper is invalid.");
            }
        ...
        public bool HasUIGroup(string uiGroupName)
        {
            ...
            {
                throw new BaseFrameworkException("UI group name is invalid.");
            }
        ...
        public bool AddUIGroup(string uiGroupName, int uiGroupDepth, IUIGroupHelper uiGroupHelper)
        {
            ...
            {
                throw new BaseFrameworkException("UI group helper is invalid.");
            }
        ...
        public bool HasUIForm(string uiFormAssetName)
        {
            ...
            {
                throw new BaseFrameworkException("UI form asset name is invalid.");
            }
        ...
        public int OpenUIForm(string uiFormAssetName, string uiGroupName, int priority, bool pauseCoveredUIForm, object userData)
        {
            ...
            {
                throw new BaseFrameworkException("You must set UI form helper first.");
            }
            ...
            if (uiGroup == null)
            {
                throw new BaseFrameworkException(Utility.Text.Format("UI group '{0}' is not exist.", uiGroupName));
            }
        ...
        public void CloseUIForm(int serialId, object userData)
        {
            ...
            if (uiForm == null)
            {
                throw new BaseFrameworkException(Utility.Text.Format("Can not find UI form '{0}'.", serialId));
            }
        ...
        public void CloseUIForm(IUIForm uiForm, object userData)
        {
            if (uiForm == null)
            {
                throw new BaseFrameworkException("UI form is invalid.");
            }

            UIGroup uiGroup = (UIGroup)uiForm.UIGroup;
            if (uiGroup == null)
            {
                throw new BaseFrameworkException("UI group is invalid.");
            }
        ...
        public void SetUIFormInstanceLocked(object uiFormInstance, bool locked)
        {
            ...
            {
                throw new BaseFrameworkException("UI form instance is invalid.");
            }
        ...
        private void InternalOpenUIForm(int serialId, string uiFormAssetName, UIGroup uiGroup, object uiFormInstance, bool pauseCoveredUIForm, bool isNewInstance, float duration, object userData)
        {
            try
            {
                ...
                if (uiForm == null)
                {
                    throw new BaseFrameworkException("Can not create UI form in UI form helper.");
                }
        ...
        private void LoadAssetSuccessCallback(string uiFormAssetName, object uiFormAsset, float duration, object userData)
        {
            ...
            {
                throw new BaseFrameworkException("Open UI form info is invalid.");
            }
