...
namespace BaseFramework.UI
{
    internal sealed partial class UIManager : BaseFrameworkModule, IUIManager
    {
        ...
        private sealed partial class UIGroup : IUIGroup
        {
            ...
            private readonly BaseFrameworkLinkedList<UIFormInfo> m_UIFormInfos;
            ...
            public UIGroup(string name, int depth, IUIGroupHelper uiGroupHelper)
            {
                ...
                m_UIFormInfos = new BaseFrameworkLinkedList<UIFormInfo>();
                m_CachedNode = null;
                Depth = depth;
            }
            ...
            public void RemoveUIForm(IUIForm uiForm)
            {
                ...
                if (uiFormInfo == null)
                {
                    throw new BaseFrameworkException(Utility.Text.Format("Can not find UI form info for serial id '{0}', UI form asset name is '{1}'.", uiForm.SerialId, uiForm.UIFormAssetName));
                }
                ...
                {
                    throw new BaseFrameworkException(Utility.Text.Format("UI group '{0}' not exists specified UI form '[{1}]{2}'.", m_Name, uiForm.SerialId, uiForm.UIFormAssetName));
                }
            ...
            public void RefocusUIForm(IUIForm uiForm, object userData)
            {
                ...
                if (uiFormInfo == null)
                {
                    throw new BaseFrameworkException("Can not find UI form info.");
                }
