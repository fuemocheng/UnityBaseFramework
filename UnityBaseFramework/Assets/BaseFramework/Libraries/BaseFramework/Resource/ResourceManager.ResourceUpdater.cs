...
namespace BaseFramework.Resource
{
    internal sealed partial class ResourceManager : BaseFrameworkModule, IResourceManager
    {
        ...
        private sealed partial class ResourceUpdater
        {
            ...
            public BaseFrameworkAction<string, int, long> ResourceApplyStart;
            public BaseFrameworkAction<ResourceName, string, string, int, int> ResourceApplySuccess;
            public BaseFrameworkAction<ResourceName, string, string> ResourceApplyFailure;
            public BaseFrameworkAction<string, bool> ResourceApplyComplete;
            public BaseFrameworkAction<ResourceName, string, string, int, int, int> ResourceUpdateStart;
            public BaseFrameworkAction<ResourceName, string, string, int, int> ResourceUpdateChanged;
            public BaseFrameworkAction<ResourceName, string, string, int, int> ResourceUpdateSuccess;
            public BaseFrameworkAction<ResourceName, string, int, int, string> ResourceUpdateFailure;
            public BaseFrameworkAction<ResourceGroup, bool> ResourceUpdateComplete;
            public BaseFrameworkAction ResourceUpdateAllComplete;
            ...
            public void ApplyResources(string resourcePackPath)
            {
                ...
                {
                    throw new BaseFrameworkException("You must check resources complete first.");
                }

                if (m_ApplyingResourcePackStream != null)
                {
                    throw new BaseFrameworkException(Utility.Text.Format("There is already a resource pack '{0}' being applied.", m_ApplyingResourcePackPath));
                }

                if (m_UpdatingResourceGroup != null)
                {
                    throw new BaseFrameworkException(Utility.Text.Format("There is already a resource group '{0}' being updated.", m_UpdatingResourceGroup.Name));
                }

                if (m_UpdateWaitingInfoWhilePlaying.Count > 0)
                {
                    throw new BaseFrameworkException("There are already some resources being updated while playing.");
                }
                ...
                try
                {
                    ...
                    {
                        throw new BaseFrameworkException("Deserialize resource pack version list failure.");
                    }

                    if (versionList.Offset + versionList.Length != length)
                    {
                        throw new BaseFrameworkException("Resource pack length is invalid.");
                    }
                ...
                catch (Exception exception)
                {
                    ...
                    throw new BaseFrameworkException(Utility.Text.Format("Apply resources '{0}' with exception '{1}'.", resourcePackPath, exception), exception);
                }
            }
            ...
            public void UpdateResources(ResourceGroup resourceGroup)
            {
                if (m_DownloadManager == null)
                {
                    throw new BaseFrameworkException("You must set download manager first.");
                }
            ...
            public void StopUpdateResources()
            {
                ...
                if (m_UpdatingResourceGroup == null)
                {
                    throw new BaseFrameworkException("There is no resource group being updated.");
                }
            ...
            private void GenerateReadWriteVersionList()
            {
                ...
                try
                {
                    ...
                    {
                        throw new BaseFrameworkException("Serialize read-write version list failure.");
                    }
                ...
                catch (Exception exception)
                {
                    ...
                    throw new BaseFrameworkException(Utility.Text.Format("Generate read-write version list exception '{0}'.", exception), exception);
                }
            ...
            private void OnDownloadStart(object sender, DownloadStartEventArgs e)
            {
                ...
                {
                    throw new BaseFrameworkException(Utility.Text.Format("File '{0}' is too large.", e.DownloadPath));
                }
