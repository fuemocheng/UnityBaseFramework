using BaseFramework.Download;
using BaseFramework.FileSystem;
using BaseFramework.ObjectPool;
using System;
    ...
    internal sealed partial class ResourceManager : BaseFrameworkModule, IResourceManager
    {
        ...
        public int GenerateReadWriteVersionListLength
        {
            ...
            set
            {
                ...
                {
                    throw new BaseFrameworkException("You can not use GenerateReadWriteVersionListLength at this time.");
                }
        ...
        public int UpdateRetryCount
        {
            ...
            set
            {
                if (m_ResourceUpdater == null)
                {
                    throw new BaseFrameworkException("You can not use UpdateRetryCount at this time.");
                }
        ...
        public void SetReadOnlyPath(string readOnlyPath)
        {
            ...
            {
                throw new BaseFrameworkException("Read-only path is invalid.");
            }

            if (m_RefuseSetFlag)
            {
                throw new BaseFrameworkException("You can not set read-only path at this time.");
            }

            if (m_ResourceLoader.TotalAgentCount > 0)
            {
                throw new BaseFrameworkException("You must set read-only path before add load resource agent helper.");
            }
        ...
        public void SetReadWritePath(string readWritePath)
        {
            ...
            {
                throw new BaseFrameworkException("Read-write path is invalid.");
            }

            if (m_RefuseSetFlag)
            {
                throw new BaseFrameworkException("You can not set read-write path at this time.");
            }

            if (m_ResourceLoader.TotalAgentCount > 0)
            {
                throw new BaseFrameworkException("You must set read-write path before add load resource agent helper.");
            }
        ...
        public void SetResourceMode(ResourceMode resourceMode)
        {
            ...
            {
                throw new BaseFrameworkException("Resource mode is invalid.");
            }

            if (m_RefuseSetFlag)
            {
                throw new BaseFrameworkException("You can not set resource mode at this time.");
            }
            ...
            {
                throw new BaseFrameworkException("You can not change resource mode at this time.");
            }
        }
        ...
        public void SetCurrentVariant(string currentVariant)
        {
            if (m_RefuseSetFlag)
            {
                throw new BaseFrameworkException("You can not set current variant at this time.");
            }
        ...
        public void SetObjectPoolManager(IObjectPoolManager objectPoolManager)
        {
            ...
            {
                throw new BaseFrameworkException("Object pool manager is invalid.");
            }
        ...
        public void SetFileSystemManager(IFileSystemManager fileSystemManager)
        {
            ...
            {
                throw new BaseFrameworkException("File system manager is invalid.");
            }
        ...
        public void SetDownloadManager(IDownloadManager downloadManager)
        {
            ...
            {
                throw new BaseFrameworkException("Download manager is invalid.");
            }
        ...
        public void SetDecryptResourceCallback(DecryptResourceCallback decryptResourceCallback)
        {
            if (m_ResourceLoader.TotalAgentCount > 0)
            {
                throw new BaseFrameworkException("You must set decrypt resource callback before add load resource agent helper.");
            }
        ...
        public void SetResourceHelper(IResourceHelper resourceHelper)
        {
            ...
            {
                throw new BaseFrameworkException("Resource helper is invalid.");
            }

            if (m_ResourceLoader.TotalAgentCount > 0)
            {
                throw new BaseFrameworkException("You must set resource helper before add load resource agent helper.");
            }
        ...
        public void InitResources(InitResourcesCompleteCallback initResourcesCompleteCallback)
        {
            ...
            {
                throw new BaseFrameworkException("Init resources complete callback is invalid.");
            }

            if (m_ResourceMode == ResourceMode.Unspecified)
            {
                throw new BaseFrameworkException("You must set resource mode first.");
            }

            if (m_ResourceMode != ResourceMode.Package)
            {
                throw new BaseFrameworkException("You can not use InitResources without package resource mode.");
            }

            if (m_ResourceIniter == null)
            {
                throw new BaseFrameworkException("You can not use InitResources at this time.");
            }
        ...
        public CheckVersionListResult CheckVersionList(int latestInternalResourceVersion)
        {
            ...
            {
                throw new BaseFrameworkException("You can not use CheckVersionList without updatable resource mode.");
            }

            if (m_VersionListProcessor == null)
            {
                throw new BaseFrameworkException("You can not use CheckVersionList at this time.");
            }
        ...
        public void UpdateVersionList(int versionListLength, int versionListHashCode, int versionListCompressedLength, int versionListCompressedHashCode, UpdateVersionListCallbacks updateVersionListCallbacks)
        {
            ...
            {
                throw new BaseFrameworkException("Update version list callbacks is invalid.");
            }
            ...
            if (m_ResourceMode != ResourceMode.Updatable && m_ResourceMode != ResourceMode.UpdatableWhilePlaying)
            {
                throw new BaseFrameworkException("You can not use UpdateVersionList without updatable resource mode.");
            }

            if (m_VersionListProcessor == null)
            {
                throw new BaseFrameworkException("You can not use UpdateVersionList at this time.");
            }
        ...
        public void VerifyResources(int verifyResourceLengthPerFrame, VerifyResourcesCompleteCallback verifyResourcesCompleteCallback)
        {
            ...
            {
                throw new BaseFrameworkException("Verify resources complete callback is invalid.");
            }
            ...
            if (m_ResourceMode != ResourceMode.Updatable && m_ResourceMode != ResourceMode.UpdatableWhilePlaying)
            {
                throw new BaseFrameworkException("You can not use VerifyResources without updatable resource mode.");
            }

            if (m_RefuseSetFlag)
            {
                throw new BaseFrameworkException("You can not verify resources at this time.");
            }
        ...
        public void CheckResources(bool ignoreOtherVariant, CheckResourcesCompleteCallback checkResourcesCompleteCallback)
        {
            ...
            {
                throw new BaseFrameworkException("Check resources complete callback is invalid.");
            }
            ...
            if (m_ResourceMode != ResourceMode.Updatable && m_ResourceMode != ResourceMode.UpdatableWhilePlaying)
            {
                throw new BaseFrameworkException("You can not use CheckResources without updatable resource mode.");
            }

            if (m_ResourceChecker == null)
            {
                throw new BaseFrameworkException("You can not use CheckResources at this time.");
            }
        ...
        public void ApplyResources(string resourcePackPath, ApplyResourcesCompleteCallback applyResourcesCompleteCallback)
        {
            ...
            {
                throw new BaseFrameworkException("Resource pack path is invalid.");
            }

            if (!File.Exists(resourcePackPath))
            {
                throw new BaseFrameworkException(Utility.Text.Format("Resource pack '{0}' is not exist.", resourcePackPath));
            }

            if (applyResourcesCompleteCallback == null)
            {
                throw new BaseFrameworkException("Apply resources complete callback is invalid.");
            }
            ...
            if (m_ResourceMode != ResourceMode.Updatable && m_ResourceMode != ResourceMode.UpdatableWhilePlaying)
            {
                throw new BaseFrameworkException("You can not use ApplyResources without updatable resource mode.");
            }

            if (m_ResourceUpdater == null)
            {
                throw new BaseFrameworkException("You can not use ApplyResources at this time.");
            }
        ...
        public void UpdateResources(string resourceGroupName, UpdateResourcesCompleteCallback updateResourcesCompleteCallback)
        {
            ...
            {
                throw new BaseFrameworkException("Update resources complete callback is invalid.");
            }
            ...
            if (m_ResourceMode != ResourceMode.Updatable && m_ResourceMode != ResourceMode.UpdatableWhilePlaying)
            {
                throw new BaseFrameworkException("You can not use UpdateResources without updatable resource mode.");
            }

            if (m_ResourceUpdater == null)
            {
                throw new BaseFrameworkException("You can not use UpdateResources at this time.");
            }

            ResourceGroup resourceGroup = (ResourceGroup)GetResourceGroup(resourceGroupName);
            if (resourceGroup == null)
            {
                throw new BaseFrameworkException(Utility.Text.Format("Can not find resource group '{0}'.", resourceGroupName));
            }
        ...
        public void StopUpdateResources()
        {
            ...
            if (m_ResourceMode != ResourceMode.Updatable && m_ResourceMode != ResourceMode.UpdatableWhilePlaying)
            {
                throw new BaseFrameworkException("You can not use StopUpdateResources without updatable resource mode.");
            }

            if (m_ResourceUpdater == null)
            {
                throw new BaseFrameworkException("You can not use StopUpdateResources at this time.");
            }
        ...
        public bool VerifyResourcePack(string resourcePackPath)
        {
            ...
            if (m_ResourceMode != ResourceMode.Updatable && m_ResourceMode != ResourceMode.UpdatableWhilePlaying)
            {
                throw new BaseFrameworkException("You can not use VerifyResourcePack without updatable resource mode.");
            }

            if (m_ResourcePackVersionListSerializer == null)
            {
                throw new BaseFrameworkException("You can not use VerifyResourcePack at this time.");
            }
        ...
        public HasAssetResult HasAsset(string assetName)
        {
            ...
            {
                throw new BaseFrameworkException("Asset name is invalid.");
            }
        ...
        public void LoadAsset(string assetName, LoadAssetCallbacks loadAssetCallbacks)
        {
            ...
            {
                throw new BaseFrameworkException("Load asset callbacks is invalid.");
            }
        ...
        public void UnloadAsset(object asset)
        {
            if (asset == null)
            {
                throw new BaseFrameworkException("Asset is invalid.");
            }
        ...
        public void LoadScene(string sceneAssetName, LoadSceneCallbacks loadSceneCallbacks)
        {
            ...
            {
                throw new BaseFrameworkException("Load scene callbacks is invalid.");
            }
        ...
        public void UnloadScene(string sceneAssetName, UnloadSceneCallbacks unloadSceneCallbacks)
        {
            ...
            {
                throw new BaseFrameworkException("Unload scene callbacks is invalid.");
            }
        ...
        public string GetBinaryPath(string binaryAssetName)
        {
            ...
            {
                throw new BaseFrameworkException("Binary asset name is invalid.");
            }
        ...
        public void LoadBinary(string binaryAssetName, LoadBinaryCallbacks loadBinaryCallbacks)
        {
            ...
            {
                throw new BaseFrameworkException("Load binary callbacks is invalid.");
            }
        ...
        public int LoadBinaryFromFileSystem(string binaryAssetName, byte[] buffer)
        {
            ...
            if (buffer == null)
            {
                throw new BaseFrameworkException("Buffer is invalid.");
            }
        ...
        public IResourceGroupCollection GetResourceGroupCollection(params string[] resourceGroupNames)
        {
            ...
            {
                throw new BaseFrameworkException("Resource group names is invalid.");
            }
            ...
            for (int i = 0; i < resourceGroupNames.Length; i++)
            {
                ...
                {
                    throw new BaseFrameworkException("Resource group name is invalid.");
                }

                resourceGroups[i] = (ResourceGroup)GetResourceGroup(resourceGroupNames[i]);
                if (resourceGroups[i] == null)
                {
                    throw new BaseFrameworkException(Utility.Text.Format("Resource group '{0}' is not exist.", resourceGroupNames[i]));
                }
            }
        ...
        private IFileSystem GetFileSystem(string fileSystemName, bool storageInReadOnly)
        {
            ...
            {
                throw new BaseFrameworkException("File system name is invalid.");
            }
