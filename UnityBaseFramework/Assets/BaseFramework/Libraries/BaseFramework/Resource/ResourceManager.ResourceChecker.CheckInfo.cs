        ...
        private sealed partial class ResourceChecker
        {
            ...
            private sealed partial class CheckInfo
            {
                ...
                public void SetVersionInfo(LoadType loadType, int length, int hashCode, int compressedLength, int compressedHashCode)
                {
                    ...
                    {
                        throw new BaseFrameworkException(Utility.Text.Format("You must set version info of '{0}' only once.", m_ResourceName.FullName));
                    }
                ...
                public void SetReadOnlyInfo(LoadType loadType, int length, int hashCode)
                {
                    ...
                    {
                        throw new BaseFrameworkException(Utility.Text.Format("You must set read-only info of '{0}' only once.", m_ResourceName.FullName));
                    }
                ...
                public void SetReadWriteInfo(LoadType loadType, int length, int hashCode)
                {
                    ...
                    {
                        throw new BaseFrameworkException(Utility.Text.Format("You must set read-write info of '{0}' only once.", m_ResourceName.FullName));
                    }
