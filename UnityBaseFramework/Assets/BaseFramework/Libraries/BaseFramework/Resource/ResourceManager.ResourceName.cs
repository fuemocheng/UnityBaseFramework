    ...
    internal sealed partial class ResourceManager : BaseFrameworkModule, IResourceManager
    {
        ...
        private struct ResourceName : IComparable, IComparable<ResourceName>, IEquatable<ResourceName>
        {
            ...
            public ResourceName(string name, string variant, string extension)
            {
                ...
                {
                    throw new BaseFrameworkException("Resource name is invalid.");
                }

                if (string.IsNullOrEmpty(extension))
                {
                    throw new BaseFrameworkException("Resource extension is invalid.");
                }
            ...
            public int CompareTo(object value)
            {
                ...
                {
                    throw new BaseFrameworkException("Type of value is invalid.");
                }
