...
namespace BaseFramework.Resource
{
    internal sealed partial class ResourceManager : BaseFrameworkModule, IResourceManager
    {
        ...
        private sealed partial class ResourceVerifier
        {
            ...
            public BaseFrameworkAction<int, long> ResourceVerifyStart;
            public BaseFrameworkAction<ResourceName, int> ResourceVerifySuccess;
            public BaseFrameworkAction<ResourceName> ResourceVerifyFailure;
            public BaseFrameworkAction<bool> ResourceVerifyComplete;
            ...
            public void VerifyResources(int verifyResourceLengthPerFrame)
            {
                ...
                {
                    throw new BaseFrameworkException("Verify resource count per frame is invalid.");
                }
