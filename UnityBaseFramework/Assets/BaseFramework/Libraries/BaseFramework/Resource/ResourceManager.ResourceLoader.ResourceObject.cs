            ...
            private sealed class ResourceObject : ObjectBase
            {
                ...
                protected internal override void Release(bool isShutdown)
                {
                    if (!isShutdown)
                    {
                        ...
                        {
                            throw new BaseFrameworkException(Utility.Text.Format("Resource target '{0}' reference count is '{1}' larger than 0.", Name, targetReferenceCount));
                        }
                        ...
                        foreach (object dependencyResource in m_DependencyResources)
                        {
                            ...
                            {
                                throw new BaseFrameworkException(Utility.Text.Format("Resource target '{0}' dependency asset reference count is invalid.", Name));
                            }
                        }
                    }
