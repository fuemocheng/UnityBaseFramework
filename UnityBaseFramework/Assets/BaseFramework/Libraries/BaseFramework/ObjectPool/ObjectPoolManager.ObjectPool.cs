...
{
    internal sealed partial class ObjectPoolManager : BaseFrameworkModule, IObjectPoolManager
    {
        /// <summary>
        /// 对象池。
        /// </summary>
        ...
        {
            private readonly BaseFrameworkMultiDictionary<string, Object<T>> m_Objects;
            ...
            public ObjectPool(string name, bool allowMultiSpawn, float autoReleaseInterval, int capacity, float expireTime, int priority)
                : base(name)
            {
                m_Objects = new BaseFrameworkMultiDictionary<string, Object<T>>();
            ...
            public override int Capacity
            {
                ...
                set
                {
                    if (value < 0)
                    {
                        throw new BaseFrameworkException("Capacity is invalid.");
                    }
            ...
            public override float ExpireTime
            {
                ...
                set
                {
                    if (value < 0f)
                    {
                        throw new BaseFrameworkException("ExpireTime is invalid.");
                    }
            ...
            public void Register(T obj, bool spawned)
            {
                if (obj == null)
                {
                    throw new BaseFrameworkException("Object is invalid.");
                }
            ...
            public bool CanSpawn(string name)
            {
                ...
                BaseFrameworkLinkedListRange<Object<T>> objectRange = default(BaseFrameworkLinkedListRange<Object<T>>);
            ...
            public void Unspawn(object target)
            {
                if (target == null)
                {
                    throw new BaseFrameworkException("Target is invalid.");
                }
                ...
                {
                    throw new BaseFrameworkException(Utility.Text.Format("Can not find target in object pool '{0}', target type is '{1}', target value is '{2}'.", new TypeNamePair(typeof(T), Name), target.GetType().FullName, target));
                }
            }
            ...
            public void Release(int toReleaseCount, ReleaseObjectFilterCallback<T> releaseObjectFilterCallback)
            {
                ...
                {
                    throw new BaseFrameworkException("Release object filter callback is invalid.");
                }
            ...
            public override ObjectInfo[] GetAllObjectInfos()
            {
                ...
                foreach (KeyValuePair<string, BaseFrameworkLinkedListRange<Object<T>>> objectRanges in m_Objects)
                {
