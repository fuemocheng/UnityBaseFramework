...
namespace BaseFramework.Sound
{
    /// <summary>
    /// 声音管理器。
    /// </summary>
    internal sealed partial class SoundManager : BaseFrameworkModule, ISoundManager
    {
        ...
        public void SetSoundHelper(ISoundHelper soundHelper)
        {
            if (soundHelper == null)
            {
                throw new BaseFrameworkException("Sound helper is invalid.");
            }
        ...
        public bool HasSoundGroup(string soundGroupName)
        {
            ...
            {
                throw new BaseFrameworkException("Sound group name is invalid.");
            }
        ...
        public bool AddSoundGroup(string soundGroupName, bool soundGroupAvoidBeingReplacedBySamePriority, bool soundGroupMute, float soundGroupVolume, ISoundGroupHelper soundGroupHelper)
        {
            ...
            {
                throw new BaseFrameworkException("Sound group helper is invalid.");
            }
        ...
        public void AddSoundAgentHelper(string soundGroupName, ISoundAgentHelper soundAgentHelper)
        {
            ...
            {
                throw new BaseFrameworkException("You must set sound helper first.");
            }

            SoundGroup soundGroup = (SoundGroup)GetSoundGroup(soundGroupName);
            if (soundGroup == null)
            {
                throw new BaseFrameworkException(Utility.Text.Format("Sound group '{0}' is not exist.", soundGroupName));
            }
        ...
        public void PauseSound(int serialId, float fadeOutSeconds)
        {
            ...
            throw new BaseFrameworkException(Utility.Text.Format("Can not find sound '{0}'.", serialId));
        }
        ...
        private void LoadAssetSuccessCallback(string soundAssetName, object soundAsset, float duration, object userData)
        {
            ...
            {
                throw new BaseFrameworkException("Play sound info is invalid.");
            }
