...
namespace BaseFramework.Config
{
    ...
    /// 全局配置管理器。
    /// </summary>
    internal sealed partial class ConfigManager : BaseFrameworkModule, IConfigManager
    {
        ...
        public void SetConfigHelper(IConfigHelper configHelper)
        {
            ...
            {
                throw new BaseFrameworkException("Config helper is invalid.");
            }
        ...
        public bool GetBool(string configName)
        {
            ...
            {
                throw new BaseFrameworkException(Utility.Text.Format("Config name '{0}' is not exist.", configName));
            }
        ...
        private ConfigData? GetConfigData(string configName)
        {
            ...
            {
                throw new BaseFrameworkException("Config name is invalid.");
            }
