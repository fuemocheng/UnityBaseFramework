    ...
    public static partial class Utility
    {
        ...
        public static partial class Json
        {
            ...
            public static string ToJson(object obj)
            {
                ...
                {
                    throw new BaseFrameworkException("JSON helper is invalid.");
                }
                ...
                catch (Exception exception)
                {
                    ...
                    throw new BaseFrameworkException(Text.Format("Can not convert to JSON with exception '{0}'.", exception), exception);
                }
            }
            ...
            public static T ToObject<T>(string json)
            {
                ...
                catch (Exception exception)
                {
                    ...
                    throw new BaseFrameworkException(Text.Format("Can not convert to object with exception '{0}'.", exception), exception);
                }
            }
