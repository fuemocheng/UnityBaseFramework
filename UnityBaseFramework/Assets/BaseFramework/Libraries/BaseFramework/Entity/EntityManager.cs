...
namespace BaseFramework.Entity
{
    ...
    /// 实体管理器。
    /// </summary>
    internal sealed partial class EntityManager : BaseFrameworkModule, IEntityManager
    {
        ...
        internal override void Update(float elapseSeconds, float realElapseSeconds)
        {
            while (m_RecycleQueue.Count > 0)
            {
                ...
                if (entityGroup == null)
                {
                    throw new BaseFrameworkException("Entity group is invalid.");
                }
        ...
        public void SetEntityHelper(IEntityHelper entityHelper)
        {
            ...
            {
                throw new BaseFrameworkException("Entity helper is invalid.");
            }
        ...
        public bool HasEntityGroup(string entityGroupName)
        {
            ...
            {
                throw new BaseFrameworkException("Entity group name is invalid.");
            }
        ...
        public bool AddEntityGroup(string entityGroupName, float instanceAutoReleaseInterval, int instanceCapacity, float instanceExpireTime, int instancePriority, IEntityGroupHelper entityGroupHelper)
        {
            ...
            {
                throw new BaseFrameworkException("Entity group helper is invalid.");
            }

            if (m_ObjectPoolManager == null)
            {
                throw new BaseFrameworkException("You must set object pool manager first.");
            }
        ...
        public bool HasEntity(string entityAssetName)
        {
            ...
            {
                throw new BaseFrameworkException("Entity asset name is invalid.");
            }
        ...
        public void ShowEntity(int entityId, string entityAssetName, string entityGroupName, int priority, object userData)
        {
            ...
            {
                throw new BaseFrameworkException("You must set entity helper first.");
            }
            ...
            {
                throw new BaseFrameworkException(Utility.Text.Format("Entity id '{0}' is already exist.", entityId));
            }

            if (IsLoadingEntity(entityId))
            {
                throw new BaseFrameworkException(Utility.Text.Format("Entity '{0}' is already being loaded.", entityId));
            }

            EntityGroup entityGroup = (EntityGroup)GetEntityGroup(entityGroupName);
            if (entityGroup == null)
            {
                throw new BaseFrameworkException(Utility.Text.Format("Entity group '{0}' is not exist.", entityGroupName));
            }
        ...
        public void HideEntity(int entityId, object userData)
        {
            ...
            if (entityInfo == null)
            {
                throw new BaseFrameworkException(Utility.Text.Format("Can not find entity '{0}'.", entityId));
            }
        ...
        public void HideEntity(IEntity entity, object userData)
        {
            if (entity == null)
            {
                throw new BaseFrameworkException("Entity is invalid.");
            }
        ...
        public IEntity GetParentEntity(int childEntityId)
        {
            ...
            {
                throw new BaseFrameworkException(Utility.Text.Format("Can not find child entity '{0}'.", childEntityId));
            }
        ...
        public IEntity GetParentEntity(IEntity childEntity)
        {
            if (childEntity == null)
            {
                throw new BaseFrameworkException("Child entity is invalid.");
            }
        ...
        public int GetChildEntityCount(int parentEntityId)
        {
            ...
            {
                throw new BaseFrameworkException(Utility.Text.Format("Can not find parent entity '{0}'.", parentEntityId));
            }
        ...
        public IEntity GetChildEntity(IEntity parentEntity)
        {
            ...
            {
                throw new BaseFrameworkException("Parent entity is invalid.");
            }
        ...
        public void AttachEntity(int childEntityId, int parentEntityId, object userData)
        {
            ...
            {
                throw new BaseFrameworkException(Utility.Text.Format("Can not attach entity when child entity id equals to parent entity id '{0}'.", parentEntityId));
            }
            ...
            {
                throw new BaseFrameworkException(Utility.Text.Format("Can not attach entity when child entity status is '{0}'.", childEntityInfo.Status));
            }
            ...
            {
                throw new BaseFrameworkException(Utility.Text.Format("Can not attach entity when parent entity status is '{0}'.", parentEntityInfo.Status));
            }
        ...
        public void DetachEntity(int childEntityId, object userData)
        {
            ...
            if (parentEntityInfo == null)
            {
                throw new BaseFrameworkException(Utility.Text.Format("Can not find parent entity '{0}'.", parentEntity.Id));
            }
        ...
        private void InternalShowEntity(int entityId, string entityAssetName, EntityGroup entityGroup, object entityInstance, bool isNewInstance, float duration, object userData)
        {
            try
            {
                ...
                if (entity == null)
                {
                    throw new BaseFrameworkException("Can not create entity in entity helper.");
                }
        ...
        private void InternalHideEntity(EntityInfo entityInfo, object userData)
        {
            ...
            {
                throw new BaseFrameworkException("Entity info is unmanaged.");
            }
        ...
        private void LoadAssetSuccessCallback(string entityAssetName, object entityAsset, float duration, object userData)
        {
            ...
            {
                throw new BaseFrameworkException("Show entity info is invalid.");
            }
