...
namespace BaseFramework.Entity
{
    internal sealed partial class EntityManager : BaseFrameworkModule, IEntityManager
    {
        ...
        private sealed class EntityGroup : IEntityGroup
        {
            ...
            private readonly BaseFrameworkLinkedList<IEntity> m_Entities;
            ...
            public EntityGroup(string name, float instanceAutoReleaseInterval, int instanceCapacity, float instanceExpireTime, int instancePriority, IEntityGroupHelper entityGroupHelper, IObjectPoolManager objectPoolManager)
            {
                ...
                m_Entities = new BaseFrameworkLinkedList<IEntity>();
                m_CachedNode = null;
            }
            ...
            public void RemoveEntity(IEntity entity)
            {
                ...
                {
                    throw new BaseFrameworkException(Utility.Text.Format("Entity group '{0}' not exists specified entity '[{1}]{2}'.", m_Name, entity.Id, entity.EntityAssetName));
                }
            }
            ...
            public void SetEntityInstanceLocked(object entityInstance, bool locked)
            {
                ...
                {
                    throw new BaseFrameworkException("Entity instance is invalid.");
                }
