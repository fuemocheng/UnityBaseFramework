    ...
    internal sealed partial class EntityManager : BaseFrameworkModule, IEntityManager
    {
        ...
        private sealed class EntityInfo : IReference
        {
            ...
            public void AddChildEntity(IEntity childEntity)
            {
                ...
                {
                    throw new BaseFrameworkException("Can not add child entity which is already exist.");
                }
            ...
            public void RemoveChildEntity(IEntity childEntity)
            {
                ...
                {
                    throw new BaseFrameworkException("Can not remove child entity which is not exist.");
                }
            }
        }
    }
