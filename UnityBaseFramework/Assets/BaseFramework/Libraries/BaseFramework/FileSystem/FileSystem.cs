...
namespace BaseFramework.FileSystem
{
    /// <summary>
    /// 文件系统。
    /// </summary>
    ...
    {
        private const int ClusterSize = 1024 * 4;       //4096
        private const int CachedBytesLength = 0x1000;   //4096
        ...
        private readonly BaseFrameworkMultiDictionary<int, int> m_FreeBlockIndexes;
        ...
        private FileSystem(string fullPath, FileSystemAccess access, FileSystemStream stream)
        {
            ...
            {
                throw new BaseFrameworkException("Full path is invalid.");
            }

            if (access == FileSystemAccess.Unspecified)
            {
                throw new BaseFrameworkException("Access is invalid.");
            }

            if (stream == null)
            {
                throw new BaseFrameworkException("Stream is invalid.");
            }
            ...
            m_FreeBlockIndexes = new BaseFrameworkMultiDictionary<int, int>();
        ...
        public static FileSystem Create(string fullPath, FileSystemAccess access, FileSystemStream stream, int maxFileCount, int maxBlockCount)
        {
            if (maxFileCount <= 0)
            {
                throw new BaseFrameworkException("Max file count is invalid.");
            }

            if (maxBlockCount <= 0)
            {
                throw new BaseFrameworkException("Max block count is invalid.");
            }

            if (maxFileCount > maxBlockCount)
            {
                throw new BaseFrameworkException("Max file count can not larger than max block count.");
            }
        ...
        public FileInfo GetFileInfo(string name)
        {
            ...
            {
                throw new BaseFrameworkException("Name is invalid.");
            }
        ...
        public byte[] ReadFile(string name)
        {
            ...
            {
                throw new BaseFrameworkException("File system is not readable.");
            }
        ...
        public int ReadFile(string name, byte[] buffer, int startIndex, int length)
        {
            ...
            {
                throw new BaseFrameworkException("Start index or length is invalid.");
            }
        ...
        public int ReadFile(string name, Stream stream)
        {
            ...
            if (!stream.CanWrite)
            {
                throw new BaseFrameworkException("Stream is not writable.");
            }
        ...
        public byte[] ReadFileSegment(string name, int offset, int length)
        {
            ...
            if (offset < 0)
            {
                throw new BaseFrameworkException("Index is invalid.");
            }

            if (length < 0)
            {
                throw new BaseFrameworkException("Length is invalid.");
            }
        ...
        public bool WriteFile(string name, byte[] buffer, int startIndex, int length)
        {
            ...
            {
                throw new BaseFrameworkException("File system is not writable.");
            }
            ...
            {
                throw new BaseFrameworkException(Utility.Text.Format("Name '{0}' is too long.", name));
            }
        ...
        public bool WriteFile(string name, Stream stream)
        {
            ...
            if (!stream.CanRead)
            {
                throw new BaseFrameworkException("Stream is not readable.");
            }
        ...
        public bool WriteFile(string name, string filePath)
        {
            ...
            {
                throw new BaseFrameworkException("File path is invalid");
            }
        ...
        public bool RenameFile(string oldName, string newName)
        {
            ...
            {
                throw new BaseFrameworkException("Old name is invalid.");
            }

            if (string.IsNullOrEmpty(newName))
            {
                throw new BaseFrameworkException("New name is invalid.");
            }

            if (newName.Length > byte.MaxValue)
            {
                throw new BaseFrameworkException(Utility.Text.Format("New name '{0}' is too long.", newName));
            }
        ...
        private bool TryCombineFreeBlocks(int freeBlockIndex)
        {
            ...
            foreach (KeyValuePair<int, BaseFrameworkLinkedListRange<int>> blockIndexes in m_FreeBlockIndexes)
            {
        ...
        {
            BaseFrameworkLinkedListRange<int> lengthRange = default(BaseFrameworkLinkedListRange<int>);
        ...
        private int AllocBlock(int length)
        {
            ...
            int lengthFound = -1;
            BaseFrameworkLinkedListRange<int> lengthRange = default(BaseFrameworkLinkedListRange<int>);
            foreach (KeyValuePair<int, BaseFrameworkLinkedListRange<int>> i in m_FreeBlockIndexes)
            {
                if (i.Key < length)
                {
                    continue;
