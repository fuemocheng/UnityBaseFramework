...
namespace BaseFramework.Setting
{
    /// <summary>
    /// 游戏配置管理器。
    /// </summary>
    internal sealed class SettingManager : BaseFrameworkModule, ISettingManager
    {
        ...
        public int Count
        {
            get
            {
                ...
                {
                    throw new BaseFrameworkException("Setting helper is invalid.");
                }
        ...
        public bool HasSetting(string settingName)
        {
            ...
            {
                throw new BaseFrameworkException("Setting name is invalid.");
            }
