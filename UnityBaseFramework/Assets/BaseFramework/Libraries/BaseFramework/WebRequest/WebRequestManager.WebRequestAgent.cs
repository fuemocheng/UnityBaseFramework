namespace BaseFramework.WebRequest
{
    internal sealed partial class WebRequestManager : BaseFrameworkModule, IWebRequestManager
    {
        /// <summary>
        /// Web 请求代理。
        /// </summary>
        private sealed class WebRequestAgent : ITaskAgent<WebRequestTask>
        {
            ...
            public BaseFrameworkAction<WebRequestAgent> WebRequestAgentStart;
            public BaseFrameworkAction<WebRequestAgent, byte[]> WebRequestAgentSuccess;
            public BaseFrameworkAction<WebRequestAgent, string> WebRequestAgentFailure;
            ...
            public WebRequestAgent(IWebRequestAgentHelper webRequestAgentHelper)
            {
                ...
                {
                    throw new BaseFrameworkException("Web request agent helper is invalid.");
                }
