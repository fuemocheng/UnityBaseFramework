...
namespace BaseFramework.Network
{
    internal sealed partial class NetworkManager : BaseFrameworkModule, INetworkManager
    {
        ...
        private abstract class NetworkChannelBase : INetworkChannel, IDisposable
        {
            ...
            public BaseFrameworkAction<NetworkChannelBase, object> NetworkChannelConnected;
            public BaseFrameworkAction<NetworkChannelBase> NetworkChannelClosed;
            public BaseFrameworkAction<NetworkChannelBase, int> NetworkChannelMissHeartBeat;
            public BaseFrameworkAction<NetworkChannelBase, NetworkErrorCode, SocketError, string> NetworkChannelError;
            public BaseFrameworkAction<NetworkChannelBase, object> NetworkChannelCustomError;
            ...
            public void RegisterHandler(IPacketHandler handler)
            {
                if (handler == null)
                {
                    throw new BaseFrameworkException("Packet handler is invalid.");
                }
