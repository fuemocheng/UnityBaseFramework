...
namespace BaseFramework.Localization
{
    /// <summary>
    /// 本地化管理器。
    /// </summary>
    internal sealed partial class LocalizationManager : BaseFrameworkModule, ILocalizationManager
    {
        ...
        public Language Language
        {
            ...
            set
            {
                ...
                {
                    throw new BaseFrameworkException("Language is invalid.");
                }
        ...
        public Language SystemLanguage
        {
            get
            {
                ...
                {
                    throw new BaseFrameworkException("You must set localization helper first.");
                }
        ...
        public void SetLocalizationHelper(ILocalizationHelper localizationHelper)
        {
            ...
            {
                throw new BaseFrameworkException("Localization helper is invalid.");
            }
        ...
        public bool HasRawString(string key)
        {
            ...
            {
                throw new BaseFrameworkException("Key is invalid.");
            }
