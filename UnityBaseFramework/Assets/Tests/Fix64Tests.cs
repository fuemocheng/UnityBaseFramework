...
namespace FixMath
{
    public class Fix64Tests
    {
        ...
        public void MultiplicationTestCases()
        {
            ...
            for (int i = 0; i < m_testCases.Length; ++i)
            {
                for (int j = 0; j < m_testCases.Length; ++j)
                {
                    ...
                    {
                        UnityEngine.Debug.LogFormat("Failed for FromRaw({0}) * FromRaw({1}): expected {2} but got {3}",
                                          m_testCases[i],
                                          m_testCases[j],
                                          (Fix64)expected,
                                          actualM);
            ...
            UnityEngine.Debug.LogFormat("{0} total, {1} per multiplication", sw.ElapsedMilliseconds, (double)sw.Elapsed.Milliseconds / (m_testCases.Length * m_testCases.Length));
        ...
        public void DivisionTestCases()
        {
            ...
            UnityEngine.Debug.LogFormat("{0} total, {1} per division", sw.ElapsedMilliseconds, (double)sw.Elapsed.Milliseconds / (m_testCases.Length * m_testCases.Length));
            Assert.True(failures < 1);
        }
        ...
        public void Modulus()
        {
            ...
            UnityEngine.Debug.LogFormat("Max error: {0} ({1} times precision)", deltas.Max(), deltas.Max() / Fix64.Precision);
            UnityEngine.Debug.LogFormat("Average precision: {0} ({1} times precision)", deltas.Average(), deltas.Average() / Fix64.Precision);
            UnityEngine.Debug.LogFormat("failed: {0}%", deltas.Count(d => d > Fix64.Precision) * 100.0 / deltas.Count);
        }
        ...
        //        deltas.Add(delta);
        //    }
        //    UnityEngine.Debug.LogFormat("Max error: {0} ({1} times precision)", deltas.Max(), deltas.Max() / (double)Fix64.Precision);
        //    UnityEngine.Debug.LogFormat("Average precision: {0} ({1} times precision)", deltas.Average(), deltas.Average() / (double)Fix64.Precision);
        //    UnityEngine.Debug.LogFormat("Fix64.Sin time = {0}ms, Math.Sin time = {1}ms", swf.ElapsedMilliseconds, swd.ElapsedMilliseconds);
        //}
        ...
        public void AtanBenchmark()
        {
            ...
            UnityEngine.Debug.LogFormat("Max error: {0} ({1} times precision)", deltas.Max(), deltas.Max() / Fix64.Precision);
            UnityEngine.Debug.LogFormat("Average precision: {0} ({1} times precision)", deltas.Average(), deltas.Average() / Fix64.Precision);
            UnityEngine.Debug.LogFormat("Fix64.Atan time = {0}ms, Math.Atan time = {1}ms", swf.ElapsedMilliseconds, swd.ElapsedMilliseconds);
        }
        ...
        public void Atan2Benchmark()
        {
            ...
            UnityEngine.Debug.LogFormat("Max error: {0} ({1} times precision)", deltas.Max(), deltas.Max() / Fix64.Precision);
            UnityEngine.Debug.LogFormat("Average precision: {0} ({1} times precision)", deltas.Average(), deltas.Average() / Fix64.Precision);
            UnityEngine.Debug.LogFormat("Fix64.Atan2 time = {0}ms, Math.Atan2 time = {1}ms", swf.ElapsedMilliseconds, swd.ElapsedMilliseconds);
        }
